...
from data.tf_recorfd import build_record_example
    ...
    with tf.python_io.TFRecordWriter(output_file) as record_writer:
        for input_file in input_files:
            ...
            for i in range(num_entries_in_batch):
                example = build_record_example(data[i].tostring(), labels[i])
...
def main(data_dir):
    ...
    for mode, files in file_names.items():
        ...
        output_file = os.path.join(data_dir, 'cifar-' + mode + '.record')
